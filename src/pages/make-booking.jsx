...
import {DropDownBox, SignTitle, BookingForm, SignButton} from '../components/Styled'
        ...
        <>
            ...
            <BookingForm>
                ...
                <div style={{margin:"5px"}}>
                    ...
                    <br></br>
                    <textarea rows="15" cols="40" type="text" name="comment" value={comment.comment} onChange={handleChange}  />
                </div>
                
                <SignButton>
                    <Link to="/"><button style={{margin:"10px"}}>Cancel</button></Link>
                    <button onClick={handleSubmit} style={{margin:"10px"}}>Confirm</button>
                </SignButton>
            </BookingForm>
        </>
    )
